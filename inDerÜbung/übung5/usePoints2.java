...
public class usePoints2 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("input the radius of c1:");
        Circle c1 = new Circle(p1, Double.parseDouble(br.readLine()));
        ...
        System.out.println("input the radius of c2:");
        Circle c2 = new Circle(p1, Double.parseDouble(br.readLine()));
        
        System.out.println("Distanz: " + p1.distance(p2));
        System.out.println("Distanz: " + c1.distance(c2));
    }
}
